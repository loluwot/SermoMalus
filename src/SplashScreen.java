 ...
 * @version 1.0
 *
 * <p>This is the splashscreen of the project</p>
 */
public class SplashScreen implements Screen {
    ...
    /**
     * This method will show the animation of the ellipse along with the logo
     */
    @Override
    public void show() {
    ...
    /**
     * This method will draw the text and also set the screen to the menu screen
     * @param delta application time
     */
    @Override
