...
public class Menu implements Screen {
    ...
    /**
     * Constructor overload that fades in menu
     * @param fadeIn
     */
    ...
    public void show(){
        ...
        textArea = new TextArea("Instructions\n\nUse controls W, A, D to move forward, left, and right respectively. Use left shift key to increase jump power and left ctrl key to decrease it. ", textStyle);
        ...
        table.center().bottom();
        table.add(container).colspan(2).center();
        table.add(container1).colspan(2).center();
        table.add(container2).colspan(2).center();
        table.row();
        table.add(containerInstruc).colspan(6).center();

        table.row();
        table.add(containerExit).colspan(6).center();
        table.setHeight(300);
        table.setWidth(1000);
    ...
    /**
     * Called each frame, renders images and text
